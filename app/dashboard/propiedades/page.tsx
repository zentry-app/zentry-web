...
import PropiedadesManager from "@/components/dashboard/propiedades/PropiedadesManager";
...
export default function PropiedadesPage() {
  ...
  useEffect(() => {
    if (authLoading || (!userClaims?.isGlobalAdmin && !esAdminDeResidencial))
      return;
  ...
  return (
    <div className="p-4 lg:p-6 space-y-6">
      {/* Selector de residencial — solo para global admin */}
      ...
      {residencialFilter ? (
        <PropiedadesManager residencialDocId={residencialFilter} />
      ) : (
