...
export const AdminService = {
  ...
  getSystemStats: async () => {
    try {
      console.log(
        "[AdminService] Iniciando obtención de estadísticas del sistema",
      );
      ...
      console.log(
        "[AdminService] Ejecutando consultas (count only — no document reads)",
      );
      ...
      console.error(
        "[AdminService] Error al obtener estadísticas del sistema:",
        error.message,
      );
  ...
  getAllAdmins: async (): Promise<UserModel[]> => {
    try {
      ...
      console.log(
        `[AdminService] Se encontraron ${admins.length} administradores`,
      );
      return admins;
    } catch (error: any) {
      console.error(
        "[AdminService] Error al obtener administradores:",
        error.message,
      );
      return [];
    }
   ...
   */
  setUserAsGlobalAdmin: async (
    userId: string,
    isGlobalAdmin: boolean,
  ): Promise<void> => {
    try {
      console.log(
        `[AdminService] Configurando usuario ${userId} como admin global: ${isGlobalAdmin}`,
      );
      ...
      console.log(
        `[AdminService] Usuario actualizado correctamente como admin global: ${isGlobalAdmin}`,
      );
    } catch (error: any) {
      console.error(
        "[AdminService] Error al configurar admin global:",
        error.message,
      );
      throw error;
    }
   ...
   */
  assignAdminToResidencial: async (
    adminId: string,
    residencialId: string,
  ): Promise<void> => {
    try {
      console.log(
        `[AdminService] Asignando admin ${adminId} al residencial ${residencialId}`,
      );
      ...
      console.log(
        `[AdminService] Administrador asignado correctamente al residencial`,
      );
    } catch (error: any) {
      console.error(
        "[AdminService] Error al asignar administrador a residencial:",
        error.message,
      );
      throw error;
    }
   ...
   */
  removeAdminFromResidencial: async (
    adminId: string,
    residencialId: string,
  ): Promise<void> => {
    try {
      console.log(
        `[AdminService] Eliminando admin ${adminId} del residencial ${residencialId}`,
      );
      ...
      console.log(
        `[AdminService] Administrador eliminado correctamente del residencial`,
      );
    } catch (error: any) {
      console.error(
        "[AdminService] Error al eliminar administrador de residencial:",
        error.message,
      );
      throw error;
    }
  ...
  /**
   * @deprecated No callers found — use getSystemStats() instead. 4 onSnapshot listeners per call.
   */
  subscribeToSystemStats: (onUpdate: (stats: any) => void) => {
    console.log(
      "[AdminService] Creando suscripción a estadísticas en tiempo real",
    );
    ...
    const unsubResidentes = onSnapshot(residentesQuery, (snap) => {
      console.log(
        `[AdminService] Actualización de residentes totales: ${snap.size}`,
      );
    ...
    const unsubResidenciales = onSnapshot(residencialesRef, (snap) => {
      console.log(
        `[AdminService] Actualización de residenciales totales: ${snap.size}`,
      );
    ...
    const unsubAdmins = onSnapshot(adminsQuery, (snap) => {
      console.log(
        `[AdminService] Actualización de administradores totales: ${snap.size}`,
      );
    ...
    const unsubPendingUsers = onSnapshot(pendingUsersQuery, (snap) => {
      console.log(
        `[AdminService] Actualización de usuarios pendientes: ${snap.size}`,
      );
